	...
	<div id="help" class="window" role="tabpanel" aria-label="Help">
		...
		<div class="container">
			...
			<div class="about">
				...
				<template v-if="store.state.serverConfiguration?.gitCommit">
					<p>
						The Lounge is running from source (<a
							:href="`https://github.com/CleverDinoProductions/CleverLounge/tree/${store.state.serverConfiguration?.gitCommit}`"
							target="_blank"
							rel="noopener"
					...
					<ul>
						<li>
							Compare
							<a
								:href="`https://github.com/CleverDinoProductions/CleverLounge/compare/${store.state.serverConfiguration?.gitCommit}...master`"
								target="_blank"
								rel="noopener"
								>between
						...
						<li>
							Compare
							<a
								:href="`https://github.com/CleverDinoProductions/CleverLounge/compare/${store.state.serverConfiguration?.version}...${store.state.serverConfiguration?.gitCommit}`"
								target="_blank"
								rel="noopener"
								>between
				...
				<p>
					<a
						href="https://github.com/CleverDinoProductions/CleverLounge/issues/new"
						target="_blank"
						rel="noopener"
